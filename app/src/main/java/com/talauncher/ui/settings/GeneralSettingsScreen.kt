...
@Composable
private fun FocusProductivitySection(
    enableTimeLimitPrompt: Boolean,
    onToggleTimeLimitPrompt: () -> Unit,
    recentAppsLimit: Int,
    onUpdateRecentAppsLimit: (Int) -> Unit
    ...
    SettingsSectionCard(title = stringResource(R.string.settings_focus_productivity)) {
        SettingItem(
...
private fun ContactActionsSection(
    ...
    SettingsSectionCard(title = stringResource(R.string.settings_contact_actions)) {
        SettingItem(
...
private fun WeatherSection(
    ...
    SettingsSectionCard(title = stringResource(R.string.settings_weather)) {
        Text(
...
private fun BuildInformationSection(
    ...
    SettingsSectionCard(title = stringResource(R.string.settings_build_information)) {
