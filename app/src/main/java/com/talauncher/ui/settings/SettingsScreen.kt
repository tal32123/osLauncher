    ...
    Column(
        ...
        when (selectedTab) {
            ...
            1 -> UIThemeSettingsScreen(
                ...
                showTimeBackground = uiState.showTimeBackground,
                onToggleShowTimeBackground = viewModel::updateShowTimeBackground,
                showDateBackground = uiState.showDateBackground,
                onToggleShowDateBackground = viewModel::updateShowDateBackground,
                showWeatherBackground = uiState.showWeatherBackground,
                onToggleShowWeatherBackground = viewModel::updateShowWeatherBackground,
                showMusicBackground = uiState.showMusicBackground,
                onToggleShowMusicBackground = viewModel::updateShowMusicBackground,
